...
public:
  ...
  void interpolation(cv::Mat&, size_t, size_t, size_t);
  void depthImageSmooth();
...
private:
  ...
  cv::Mat _current_smooth_depth_image;
  cv::Mat _current_projection_image;
  ...
  std::unordered_map<uint16_t, depth_clustering::Cloud> _clusters;
  cv::Mat _label_image;
};
